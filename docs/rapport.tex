...
En logique propositionnelle, chaque chemin était vérifié indépendamment (\texttt{tous\_chemins\_connectes}). En LPO, nous utilisons \texttt{parcourir\_chemins/2} pour accumuler toutes les substitutions nécessaires à la fermeture de \textbf{tous} les chemins dans une seule liste \texttt{ListeSubst}. 
